export default {
  ...
  visualizer: {
    ...
    controls: {
      ...
      pause: 'pause()',
      resume: 'resume()',
      sortingInProgress: 'সাজানো হচ্ছে...',
      sortingPausedBadge: 'বিরতি',
      engineExecuting: 'চলছে',
      enginePaused: 'বিরতিতে',
  ...
  feedback: {
    ...
    emailHint: 'শুধু উত্তর চাইলে — মার্কেটিং নয়।',
    namePlaceholder: 'আপনার নাম',
    ratingHint: 'হোভার করে দেখুন, ক্লিক করে রেট দিন (বাধ্যতামূলক)৷',
    ratingAriaGroup: '১ থেকে ৫ তারায় আপনার অভিজ্ঞতা রেট করুন',
    ratingStarLabel: '৫-এর মধ্যে {n} তারা',
    ratingCta: 'হোভার করে পেয়ে নিন, তারপর তারায় ক্লিক করে রেট দিন৷',
    ratingSaved: 'সংরক্ষিত',
    clearRating: 'মুছুন',
    ratingPrompt: 'SortVision ব্যবহার করার সময় আপনি কীভাবে মূল্যায়ন করবেন？',
    devCalloutTitle: 'ডেভেলপার? GitHub-এ অবদান',
    devCalloutBody:
      'SortVision ওপেন সোর্স। স্টার দিন, বাগ রিপোর্ট বা স্পন্সর করুন।',
    starOnGithub: 'GitHub-এ স্টার',
    sponsorOnGithub: 'স্পন্সর',
