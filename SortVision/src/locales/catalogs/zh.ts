export default {
  ...
  feedback: {
    ...
    emailHint: '仅在需要回复时填写；不会用于营销。',
    namePlaceholder: '您的姓名',
    ratingHint: '悬停预览，点击星星设置评分（必填）。',
    ratingAriaGroup: '请为体验打分，1 到 5 星',
    ratingStarLabel: '打 {n} 星（共 5 星）',
    ratingCta: '悬停预览后点击星星评分。',
    ratingSaved: '已保存',
    clearRating: '清除',
    ratingPrompt: '您如何评价使用 SortVision 的整体体验？',
    devCalloutTitle: '开发者？在 GitHub 上参与',
    devCalloutBody: 'SortVision 开源。给仓库点星、提 issue，或赞助项目。',
