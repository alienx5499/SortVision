      ...
      <div className="fixed bottom-6 right-6 z-50 group">
        <div className="relative">
          ...
          <Button
            ...
            className="relative size-16 rounded-full shadow-2xl transition-all duration-500 bg-gradient-to-br from-emerald-500 via-emerald-400 to-emerald-600 hover:from-emerald-300 hover:via-emerald-400 hover:to-emerald-500 border-2 border-emerald-300/60 hover:border-emerald-200/80 overflow-hidden group-hover:scale-110 group-hover:rotate-3 active:scale-95"
          ...
          >
            ...
            <div className="absolute inset-0 rounded-full overflow-hidden">
              ...
              />
              <div
                className="absolute bottom-3 left-3 size-0.5 bg-emerald-200 rounded-full animate-ping"
          ...
          <div className="absolute inset-0 pointer-events-none">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="absolute size-1 bg-emerald-300 rounded-full animate-ping opacity-60"
                style={{
