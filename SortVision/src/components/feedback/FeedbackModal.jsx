...
const FeedbackModal = ({ isOpen, onClose }) => {
  ...
  useEffect(() => {
    const updateTimeSpent = () => {
      ...
      const timeSpent = Math.round(
        (currentTime - persistentSessionStart) / 1000
      ); // in seconds
  ...
  const detectUserLocationEnhanced = async () => {
    ...
    try {
      ...
      if (shouldLog)
        console.log('📍 Enhanced location detected:', enhancedLocationData);
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const getDeviceInfo = () => {
        ...
        const isTablet =
          /iPad/i.test(ua) || (isMobile && window.innerWidth > 768);
                ...
                {[...Array(16)].map((_, i) => (
                  <div
                    ...
                    style={{
                      ...
                      left: `${
                        50 + 35 * Math.sin((i * 22.5 * Math.PI) / 180)
                      }%`,
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      animationDuration: formData.name ? 'none' : '2.5s',
                    }}
                  />
                </label>
                <Input
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs font-mono text-slate-500">
                  <span className="text-amber-400">//</span> Provide your email
              ...
              <div className="space-y-4 p-4 rounded-lg border border-slate-600 bg-slate-800/30">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  >
                    {[1, 2, 3, 4, 5].map(star => {
                      ...
                      const showHoverEffect =
                        hoverRating > 0 &&
                        (hoverRating > currentRating || currentRating === 0);
                  ...
                  <div className="text-center min-h-[24px]">
                    {(hoverRating || formData.rating) > 0 ? (
                            ...
                            return (
                              <span
                                className={`${label.color} ${
                                  hoverRating ? 'animate-pulse' : ''
                                }`}
                                style={{
                                  animationDuration: hoverRating
                                    ? '2s'
                                    : 'none',
                                }}
                              >
                      ...
                      <span
                        className="text-sm font-mono text-slate-500 animate-pulse"
                        style={{ animationDuration: '3s' }}
                      >
                        <span className="text-amber-400">//</span> Hover to
                        preview • Click to rate
                      </span>
                    )}
                  </div>
                ...
                <p className="text-xs font-mono text-slate-400 text-center leading-relaxed">
                  <span className="text-amber-400">//</span> How would you rate
                  your overall experience with SortVision?
                </p>
              </div>
              ...
              <div className="space-y-3">
                  ...
                  >
                    ...
                    <details className="text-xs font-mono text-slate-400">
                      <summary className="cursor-pointer hover:text-slate-300 transition-colors">
                        <span className="text-amber-400">//</span> Technical
                        details
                      </summary>
                      <div className="mt-2 pl-4 space-y-1 border-l border-slate-600">
                        ...
                        {locationData.detectionDetails?.browser && (
                          <div>
                            Browser: {locationData.detectionDetails.browser}
                          </div>
                        )}
                ...
                {(!detectedRegion || !locationData) && (
                  <div className="space-y-2">
                    ...
                    >
                      <span className="text-amber-400">$</span> Select your
                      region manually
                    </label>
                    <Select
                    ...
                    >
                      ...
                      <SelectContent className="bg-slate-800 border-slate-600">
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <span className="text-blue-400">🌎</span> Americas
                            (North & South America)
                          </div>
                        </SelectItem>
                        <SelectItem
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <span className="text-purple-400">🌏</span> Asia
                            Pacific
                          </div>
                        </SelectItem>
                        <SelectItem
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <span className="text-orange-400">🕌</span> Middle
                            East
                          </div>
                        </SelectItem>
                        <SelectItem
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <span className="text-slate-400">🌐</span> Other/Not
                            Listed
                          </div>
                        </SelectItem>
                      </SelectContent>
                    ...
                    <p className="text-xs font-mono text-slate-500">
                      <span className="text-amber-400">//</span> This helps us
                      identify region-specific issues and improve performance
                      globally
                    </p>
                  </div>
                )}
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      animationDuration: formData.feedbackType
                        ? 'none'
                        : '2.5s',
                    }}
                  />
                ...
                <div className="flex items-center justify-between">
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{
                        animationDuration: formData.detailedFeedback
                          ? 'none'
                          : '2.5s',
                      }}
                    />
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <span className="text-sm text-red-400 font-mono font-semibold">
                        <span className="text-amber-400">//</span> Submission
                        failed. Please try again.
                      </span>
                      <div className="text-xs text-red-300/80 font-mono mt-1">
                        Check your connection and retry. Your feedback is
                        important to us!
                      </div>
                    </div>
                  </div>
            ...
            <CardFooter className="flex flex-col gap-4 pt-6">
              ...
              <div className="flex items-center justify-center gap-2 text-xs text-slate-500 font-mono">
                ...
                <span>
                  <span className="text-amber-400">//</span> Your feedback helps
                  us improve SortVision
                </span>
              </div>
