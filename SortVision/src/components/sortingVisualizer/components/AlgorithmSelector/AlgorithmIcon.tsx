...
const AlgorithmIcon = ({ algorithm }: { algorithm: SortingAlgorithmId }) => {
  const icon = useMemo(() => {
    if (algorithm === 'bubble') {
      return (
        <div className="relative size-6 flex items-center justify-center">
          ...
          ></div>
          <div
            className="size-3 bg-red-400 rounded-full animate-pulse"
            style={{ animationDuration: '1.5s' }}
          ></div>
          <div
            className="absolute size-1 bg-red-300 rounded-full top-0 right-0 animate-ping"
    ...
    if (algorithm === 'selection') {
      return (
        <div className="relative size-6 flex items-center justify-center">
          <div className="size-4 border border-amber-400 rounded-sm relative overflow-hidden">
          ...
          <div
            className="absolute inset-0 m-auto size-2 bg-amber-400 rounded-sm animate-pulse"
            style={{ animationDuration: '1.5s' }}
          ></div>
        </div>
      );
    ...
    if (algorithm === 'quick') {
      return (
        <div className="relative size-6 flex items-center justify-center">
          <div
            className="size-4 border-r-2 border-t-2 border-green-400 rounded-tr-md animate-spin"
            style={{ animationDuration: '3s' }}
          ></div>
          <div
            className="absolute inset-0 size-2 bg-green-400/20 rounded-full m-auto animate-ping"
            style={{ animationDuration: '1.5s' }}
          ></div>
        </div>
      );
    ...
    if (algorithm === 'heap') {
      return (
        <div className="relative size-6 flex items-center justify-center">
          <div className="size-4 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-sm relative overflow-hidden">
          ...
          <div
            className="absolute inset-0 m-auto size-2 bg-indigo-400 rounded-sm animate-pulse"
            style={{ animationDuration: '1.5s' }}
          ></div>
        </div>
      );
    ...
    if (algorithm === 'bucket') {
      return (
        <div className="relative size-6 flex items-center justify-center">
          <div className="size-4 bg-gradient-to-br from-pink-500 to-rose-500 rounded-sm relative overflow-hidden">
          ...
          <div
            className="absolute inset-0 m-auto size-2 bg-pink-400 rounded-full animate-pulse"
            style={{ animationDuration: '1.5s' }}
          ></div>
        </div>
      );
    ...
    return (
      <div className="relative size-6 flex items-center justify-center">
        <div className="size-4 bg-gradient-to-br from-cyan-400 to-blue-400 rounded-sm animate-pulse"></div>
        <div
