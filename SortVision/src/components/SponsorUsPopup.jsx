...
const SponsorUsPopup = () => {
  ...
  useEffect(() => {
    ...
    const hasSponsored = localStorage.getItem(POPUP_CONFIG.STORAGE_KEYS.sponsored);
    const hasDismissed = localStorage.getItem(POPUP_CONFIG.STORAGE_KEYS.sponsorDismissed);
    const forceFlag = localStorage.getItem('sv-show-sponsor-popup');
    const urlFlag = typeof window !== 'undefined' && new URLSearchParams(window.location.search).get('showSponsorPopup');
  ...
  const handleDismiss = () => {
    ...
    localStorage.setItem('sortvision-sponsor-popup-dismiss-timestamp', Date.now().toString());
    setShowPopup(false);
  };
          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-400 font-mono text-sm leading-relaxed">
                ...
                Consider sponsoring us to help maintain and improve this educational tool.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-xl p-4 text-left border border-slate-700 relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  ...
                  <h4 className="font-semibold text-sm text-white">Why sponsor us?</h4>
                </div>
              </div>
              ...
              <ul className="text-xs text-slate-300 space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="mt-[3px] inline-block w-1.5 h-1.5 rounded-full bg-pink-400" />
                  <span>Help us maintain server costs and infrastructure</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="mt-[3px] inline-block w-1.5 h-1.5 rounded-full bg-pink-400" />
                  <span>
