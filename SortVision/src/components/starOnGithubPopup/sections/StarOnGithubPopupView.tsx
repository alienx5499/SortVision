...
import type { StarOnGithubPopupViewProps } from '../starOnGithubPopupContracts';
  ...
  return (
    <>
      <div
        ...
        onClick={handleLater}
        onKeyDown={e => e.key === 'Escape' && handleLater()}
        role="presentation"
        aria-hidden="true"
      />

      <div
        className="fixed inset-0 flex items-center justify-center animate-in fade-in duration-300 p-4"
        style={{ zIndex: Z_INDEX.GITHUB_STAR_MODAL }}
        role="presentation"
      >
        <div
          className="w-[380px] max-w-[90vw] bg-slate-900 border border-slate-700 shadow-2xl shadow-red-500/20 rounded-2xl relative overflow-hidden transition-transform duration-300 hover:scale-[1.01]"
          role="dialog"
          aria-modal="true"
          aria-labelledby="github-star-popup-title"
        >
          ...
          <div className="relative p-6">
            ...
            <div className="text-center space-y-6">
              <div className="space-y-2">
                ...
                <h3
                  id="github-star-popup-title"
                  className="text-xl font-bold font-mono text-white relative group"
                >
                  Enjoying SortVision?
                ...
                <p className="text-slate-400 font-mono text-sm leading-relaxed">
                  You&apos;ve been exploring algorithms for a while! If
                  you&apos;re finding SortVision helpful, consider giving us a
                  star on GitHub. It helps us reach more learners like you!
                </p>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex justify-center">
                  <StarOnGithub onClick={handleStarClick} />
                </div>
              ...
              <div className="text-xs text-slate-400 border-t border-slate-700 pt-4">
                🎯 You&apos;ve spent {Math.floor(timeSpent / 60)}m{' '}
                {timeSpent % 60}s exploring algorithms
              </div>
            </div>
          </div>
        </div>
