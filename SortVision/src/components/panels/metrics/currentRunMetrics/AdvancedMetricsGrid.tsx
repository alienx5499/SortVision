...
import type { MetricsTranslate } from '../metricsPanelContracts';
import type { CurrentRunDerivedMetrics } from './helpers';

export type AdvancedMetricsGridProps = {
  derived: CurrentRunDerivedMetrics;
  t: MetricsTranslate;
};

const AdvancedMetricsGrid = ({ derived, t }: AdvancedMetricsGridProps) => {
  return (
    <div className="flex flex-wrap sm:grid sm:grid-cols-4 gap-3">
      <div className="flex-1 min-w-[120px] bg-slate-800 p-2 rounded border border-slate-700 relative overflow-hidden group hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
        ...
        <div className="text-[10px] text-slate-400 mb-1 flex items-center group-hover:text-slate-300 transition-colors duration-300 relative z-10">
          <Percent className="mr-1 size-3 text-amber-400 group-hover:text-amber-300 transition-colors duration-300" />{' '}
          {t('metrics.swapRatio')}
        </div>
      ...
      <div className="flex-1 min-w-[120px] bg-slate-800 p-2 rounded border border-slate-700 relative overflow-hidden group hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
        ...
        <div className="text-[10px] text-slate-400 mb-1 flex items-center group-hover:text-slate-300 transition-colors duration-300 relative z-10">
          <Clock className="mr-1 size-3 text-amber-400 group-hover:text-amber-300 transition-colors duration-300" />{' '}
      ...
      <div className="flex-1 min-w-[120px] bg-slate-800 p-2 rounded border border-slate-700 relative overflow-hidden group hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
        ...
        <div className="text-[10px] text-slate-400 mb-1 flex items-center group-hover:text-slate-300 transition-colors duration-300 relative z-10">
          <Cpu className="mr-1 size-3 text-amber-400 group-hover:text-amber-300 transition-colors duration-300" />{' '}
          {t('metrics.opsMs')}
        </div>
        <div className="text-sm text-amber-400 font-mono flex items-center group-hover:text-amber-300 transition-colors duration-300 relative z-10">
      ...
      <div className="flex-1 min-w-[120px] bg-slate-800 p-2 rounded border border-slate-700 relative overflow-hidden group hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
        ...
        <div className="text-[10px] text-slate-400 mb-1 flex items-center group-hover:text-slate-300 transition-colors duration-300 relative z-10">
          <Award className="mr-1 size-3 text-amber-400 group-hover:text-amber-300 transition-colors duration-300" />{' '}
          {t('metrics.score')}
        </div>
        <div className="text-sm text-amber-400 font-mono flex items-center group-hover:text-amber-300 transition-colors duration-300 relative z-10">
