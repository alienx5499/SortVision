...
export type PrimaryMetricsGridProps = {
  metrics: SortRunMetrics;
  t: MetricsTranslate;
};

const PrimaryMetricsGrid = ({ metrics, t }: PrimaryMetricsGridProps) => {
  return (
    <div className="grid grid-cols-3 gap-4 mb-4">
      <div className="bg-slate-800 p-3 rounded border border-slate-700 relative overflow-hidden group hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
        ...
        <div className="absolute -top-10 -right-10 size-20 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 rounded-full blur-md group-hover:scale-150 transition-transform duration-700"></div>
        ...
        <div className="text-xs text-slate-400 mb-1 flex items-center group-hover:text-slate-300 transition-colors duration-300 relative z-10">
          <ArrowUpDown className="mr-1 size-3 text-emerald-400 group-hover:text-emerald-300 transition-colors duration-300" />{' '}
          {t('metrics.swaps')}
        </div>
      ...
      <div className="bg-slate-800 p-3 rounded border border-slate-700 relative overflow-hidden group hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
        ...
        <div className="absolute -top-10 -right-10 size-20 bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-full blur-md group-hover:scale-150 transition-transform duration-700"></div>
        ...
        <div className="text-xs text-slate-400 mb-1 flex items-center group-hover:text-slate-300 transition-colors duration-300 relative z-10">
          <BarChart2 className="mr-1 size-3 text-blue-400 group-hover:text-blue-300 transition-colors duration-300" />{' '}
      ...
      <div className="bg-slate-800 p-3 rounded border border-slate-700 relative overflow-hidden group hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300">
        ...
        <div className="text-xs text-slate-400 mb-1 flex items-center group-hover:text-slate-300 transition-colors duration-300 relative z-10">
          <Zap className="mr-1 size-3 text-purple-400 group-hover:text-purple-300 transition-colors duration-300" />{' '}
          {t('metrics.timeMs')}
        </div>
