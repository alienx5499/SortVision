export type RankingColorScheme = {
  panelBg: string;
  accent: string;
  border: string;
  text: string;
...
export const DEFAULT_SCHEME: RankingColorScheme = {
...
export const WINNER_SCHEME: RankingColorScheme = {
...
const GREEN_SCHEME: RankingColorScheme = {
...
const CYAN_SCHEME: RankingColorScheme = {
...
const RED_SCHEME: RankingColorScheme = {
...
export const ALGO_SCHEME_MAP: Record<string, RankingColorScheme> = {
  quick: GREEN_SCHEME,
  merge: GREEN_SCHEME,
  heap: GREEN_SCHEME,
  radix: CYAN_SCHEME,
