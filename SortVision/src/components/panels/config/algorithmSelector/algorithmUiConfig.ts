...
export const BADGE_THEME_MAP: Record<string, string> = {
  bubble:
...
export const BADGE_GRADIENT_MAP: Record<string, string> = {
...
export const BADGE_COMPLEXITY_TEXT_MAP: Record<string, string> = {
