...
export const ALGORITHM_THEME_MAP: Record<string, AlgorithmTheme> = {
  bubble: {
    cornerAccent: 'bg-gradient-to-br from-red-500/20 to-orange-500/20',
    backgroundGlow:
      'bg-gradient-to-r from-red-500/30 via-orange-500/30 to-purple-500/30',
  ...
  insertion: {
    cornerAccent: 'bg-gradient-to-br from-orange-500/20 to-amber-500/20',
    backgroundGlow:
      'bg-gradient-to-r from-orange-500/30 via-amber-500/30 to-purple-500/30',
  ...
  selection: {
    cornerAccent: 'bg-gradient-to-br from-yellow-500/20 to-yellow-500/20',
    backgroundGlow:
      'bg-gradient-to-r from-yellow-500/30 via-yellow-500/30 to-purple-500/30',
  ...
  quick: {
    cornerAccent: 'bg-gradient-to-br from-green-500/20 to-emerald-500/20',
    backgroundGlow:
      'bg-gradient-to-r from-green-500/30 via-emerald-500/30 to-purple-500/30',
  ...
  merge: {
    cornerAccent: 'bg-gradient-to-br from-blue-500/20 to-cyan-500/20',
    backgroundGlow:
      'bg-gradient-to-r from-blue-500/30 via-cyan-500/30 to-purple-500/30',
  ...
  radix: {
    cornerAccent: 'bg-gradient-to-br from-purple-500/20 to-indigo-500/20',
    backgroundGlow:
      'bg-gradient-to-r from-purple-500/30 via-indigo-500/30 to-purple-500/30',
  ...
  heap: {
    cornerAccent: 'bg-gradient-to-br from-indigo-500/20 to-purple-500/20',
    backgroundGlow:
      'bg-gradient-to-r from-indigo-500/30 via-purple-500/30 to-indigo-500/30',
  ...
  bucket: {
    cornerAccent: 'bg-gradient-to-br from-pink-500/20 to-rose-500/20',
    backgroundGlow:
      'bg-gradient-to-r from-pink-500/30 via-rose-500/30 to-pink-500/30',
...
export const DEFAULT_THEME: AlgorithmTheme = {
  cornerAccent: 'bg-gradient-to-br from-emerald-500/20 to-teal-500/20',
  backgroundGlow:
    'bg-gradient-to-r from-emerald-500/30 via-teal-500/30 to-purple-500/30',
