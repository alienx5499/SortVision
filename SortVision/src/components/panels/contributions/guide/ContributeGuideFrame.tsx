...
type ContributeGuideFrameProps = {
  title: string;
  children: ReactNode;
};

export const ContributeGuideFrame = ({
  title,
  children,
}: ContributeGuideFrameProps) => (
  <div className="mb-4 relative group">
    ...
    <div className="relative bg-slate-900 p-4 rounded border border-slate-800 transition-all duration-500 hover:border-slate-700 hover:shadow-lg hover:shadow-slate-900/50 group/guide overflow-hidden">
      ...
      <div className="absolute -top-10 -right-10 size-20 bg-gradient-to-br from-emerald-500/20 to-blue-500/20 rounded-full blur-md group-hover/guide:scale-150 transition-transform duration-700"></div>
