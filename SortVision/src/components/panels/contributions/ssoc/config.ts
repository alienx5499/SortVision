...
export const BADGE_CONFIG: Record<string, BadgeConfigEntry> = {
  ...
  BUG_HUNTER: {
    ...
    color: 'text-red-400',
    stats: true,
    getStats: participant => `${participant.bugsSolved ?? 0} bugs fixed`,
  },
  BUG_REPORTER: {
    ...
    stats: true,
    getStats: participant => `${participant.bugsReported ?? 0} bugs reported`,
  },
  TEAM_PLAYER: {
