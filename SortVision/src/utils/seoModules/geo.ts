 ...
 */
type GeoSummaryContext = 'homepage' | 'algorithm' | 'comparison';

export const getGeoSummary = (
  context: GeoSummaryContext = 'homepage',
 ...
 */
export const getPromptHooks = (
  context: 'homepage' | 'algorithm' = 'homepage',
  algorithmName: string | null = null
): string[] => {
  const hooks: string[] = [];
