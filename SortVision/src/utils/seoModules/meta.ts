 ...
 */
export const getAlgorithmMetaTags = (
 ...
 */
export const getHomepageMetaTags = (language = 'en'): MetaTagBundle => {
  const content = getLocalizedContent(language, 'homepage') as Record<
    string,
    string
  >;
 ...
 */
export const getContributionsMetaTags = (language = 'en'): MetaTagBundle => {
  ...
  const content =
    (contributionsTranslations as Record<string, any>)[language] ||
    contributionsTranslations.en;
 ...
 */
export const getSSOCMetaTags = (): MetaTagBundle => {
  return {
